...
?>
 ...
 <div id="thedevices" style="height:500px;width:100%;border:1px solid #ccc;font:16px/26px Georgia, Garamond, Serif;overflow:auto;"></div>
  ...
  <div class="panel-body">
  <div id="heat-map"><h3>Loading heat map</h3><img src="img/spinner.gif" ></img> </div>
	</div>
	</div>
 
 <script>
 $(function() {
    $( "#pathdatepicker" ).datepicker({ dateFormat: 'dd-mm-yy'}).datepicker("setDate", new Date(2014,9,31));
  });
...
var enddate = endy+"-"+endm+"-"+endd;
 ...
 var url="alldevicesdate.php?id="+mapscampaignid+"&start="+startdate+"&end="+startdate;
...
var url="devicedate.php?id="+drivers[j].deviceid+"&start="+startdate+"&end="+startdate;
