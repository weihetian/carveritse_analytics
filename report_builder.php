	...
	<div class="container">
			...
			<form role="form" class='col-md-6'>
			 ...
			 <label for="deviceid">Device id</label>
				    <input type="input" class="form-control" id="deviceid" name="name" placeholder="Enter device id">
				  </div>	
				<div class="form-group">
...
var myJsonString = JSON.stringify(coordinates);
 document.getElementById("report").innerHTML+="<img src='img/spinner.gif' ></img>";
